...
const Home: React.FC = () => {
  ...
  const [mySelectedDate, setSelectedDate] = React.useState<any>(now);
  ...
  return (
    <div>
      ...
      />
      <Popup display="bottom" fullScreen={true} contentPadding={false} headerText={headerText} anchor={anchor} buttons={popupButtons} isOpen={isOpen} onClose={onClose} responsive={responsivePopup}>
